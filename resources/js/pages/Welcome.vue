...
import { dashboard, login, register, clock, survey } from '@/routes';
    ...
    >
        ...
        >
            <nav class="flex items-center justify-end gap-4">
                <Link
                    :href="survey()"
                    class="inline-block rounded-sm border border-purple-300 bg-purple-50 px-5 py-1.5 text-sm leading-normal text-purple-700 hover:border-purple-400 hover:bg-purple-100 dark:border-purple-600 dark:bg-purple-900/20 dark:text-purple-300 dark:hover:border-purple-500 dark:hover:bg-purple-900/30"
                >
                    📋 Survey
                </Link>
                <Link
